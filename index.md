...
### AI Metadata Extraction for Regulatory PDFs

Built a BERT-based NLP pipeline to extract metadata from regulatory PDF documents during a data migration project.

[View Project](https://github.com/yourusername/project-name)

---

### Jira Prototype Workflow

Used LLM-assisted coding tools to rapidly create prototypes for product backlog discussions.
